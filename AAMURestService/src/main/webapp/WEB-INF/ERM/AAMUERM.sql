...
DROP TABLE CHATINGMESSAGE CASCADE CONSTRAINTS;
...
DROP TABLE COMMUTAG CASCADE CONSTRAINTS;
...
DROP TABLE FIREBASETABLE CASCADE CONSTRAINTS;
DROP TABLE FOLLOWER CASCADE CONSTRAINTS;
DROP TABLE HOTELINFO CASCADE CONSTRAINTS;
DROP TABLE NORIFICATION CASCADE CONSTRAINTS;
...
CREATE TABLE CHATINGMESSAGE
(
	ROOMNO  number NOT NULL,
	AUTHID  varchar2(20) NOT NULL,
	MISSAGE  nvarchar2(2000) NOT NULL,
...
(
	...
	EVENTSTART date,
	EVENTEND date,
	CHARGE nvarchar2(500),
	EVENTTIME nvarchar2(500),
	PRIMARY KEY (CONTENTID)
);


CREATE TABLE FIREBASETABLE
(
	ID varchar2(20) NOT NULL,
	FIREBASEID  nvarchar2(2000) NOT NULL,
	PRIMARY KEY (ID)
);
...
(
	NANO  number NOT NULL,
	ID varchar2(20) NOT NULL,
	AMESSAGE  nvarchar2(2000) NOT NULL,
	SENDDATE  number NOT NULL,
	READKNOW  number DEFAULT 0 NOT NULL,
	PRIMARY KEY (NANO )
);
...
(
	...
	BIGIMAGE varchar2(1000),
	SMALLIMAGE varchar2(1000),
...
(
	...
	REVIEW nvarchar2(30),
	RATEDATE date DEFAULT SYSDATE NOT NULL,
	RNO number NOT NULL,
	PRIMARY KEY (RNO)
);
...
(
	...
	ID varchar2(20) NOT NULL,
	PLANNERDATE nvarchar2(200) NOT NULL,
	PRIMARY KEY (RBN)
);
...
(
	TNO number NOT NULL,
	TNAME nvarchar2(100) NOT NULL UNIQUE,
	PRIMARY KEY (TNO)
);
...
CREATE TABLE THEME
(
	THEMEID number DEFAULT 0 NOT NULL,
	THEMENAME nvarchar2(20) NOT NULL,
	THEMEIMG nvarchar2(2000),
	PRIMARY KEY (THEMEID)
);
...
(
	...
	SOCIALNUM nvarchar2(8) NOT NULL,
	PRIMARY KEY (ID)
);
...
ALTER TABLE CHATINGMESSAGE
	ADD FOREIGN KEY (ROOMNO )
	REFERENCES CHATROOM (ROOMNO )
;
