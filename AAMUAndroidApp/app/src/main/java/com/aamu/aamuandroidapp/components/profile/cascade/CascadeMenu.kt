package com.aamu.aamuandroidapp.components.profile.cascade
...
fun CascadeHeaderItem(
    ...
    CascadeMenuItem(onClick = { onClick() }) {
        CascadeMenuItemIcon(icon = Icons.Rounded.KeyboardArrowLeft, tint = contentColor.copy(alpha = ContentAlpha.medium))
...
fun <T> CascadeParentItem(
    ...
    CascadeMenuItem(onClick = { onClick(id) }) {
        ...
        Space()
        CascadeMenuItemIcon(icon = Icons.Rounded.KeyboardArrowRight, tint = contentColor)
    }
}
